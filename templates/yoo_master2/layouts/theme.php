...
<div class="all-content"> 
		<?php if ($this['widgets']->count('home-1')) : ?>
		<section id="tm-top-a" class="<?php echo $grid_classes['home-1']; echo $display_classes['home-1']; ?>" data-uk-grid-match="{target:'> div > .uk-panel'}" data-uk-grid-margin><?php echo $this['widgets']->render('home-1', array('layout'=>$this['config']->get('grid.home-1.layout'))); ?></section>
		<?php endif; ?>  
	<div class="uk-container uk-container-center">
